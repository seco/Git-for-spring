...
<%@ include file="../../skin_jikwon_top_ver.jsp" %>
	...
	<sform:form enctype="multipart/form-data" modelAttribute="uploadFile">
		...
		<td style="text-align:center;">
			...
			<td>
				<input name="sang_Bname" style="font-size:15px;text-align:center;margin-top:20px;width:340px; height:30px;">
			</td>
		</tr>
		<tr>
		<td style="text-align:center;">
			...
			<td>
				<input name="sang_Pname" style="font-size:15px;text-align:center;margin-top:20px;width:340px; height:30px;">
			</td>
		</tr>
		<tr>
		<td style="text-align:center;">
			...
			<td>
				<input name="sang_price" style="font-size:15px;text-align:center;margin-top:20px;width:340px; height:30px;">
			</td>
		</tr>
		<tr>
		<td style="text-align:center;">
			...
			<td>
				<input name="sang_su" style="font-size:15px;text-align:center;margin-top:20px;width:340px; height:30px;">
			</td>
		</tr>
		<tr>
		<td style="text-align:center;">
			...
			<td>
				<input name="sang_detail" style="font-size:15px;text-align:center;margin-top:20px;width:340px; height:30px;">
			</td>
		</tr>
		<tr>
		<td style="text-align:center;">
