...
$(document).ready(function(){
   ...
   $("#btn1").click(function(){
	   ...
	   $("#sangFrm").attr("action","sang_order");
	   $("#sangFrm").submit();
	});
});
</script>
...
<%@ include file="../../skin_gogek_top_ver.jsp" %>
	...
	<table border="0" style="width: 70%; margin: 0 auto;">
		...
		<tr>
			<td>
			<hr>
			<form action="sangCart" id="sangFrm">
				<div class="count">
					구매수량 
			...
			<tr>
			<td>
					<input style="font-size:9pt;font-family:'Nirmala UI';background-color:BLACK;color:white;width:100px;float:left;height:30px;" type="submit" value="장바구니담기">
					<button style="font-size:9pt;font-family:'Nirmala UI';background-color:BLACK;color:white;width:100px;float:left;height:30px;" id="btn1">구매하기</button>
					<br><br>
			</td>
			</tr>
