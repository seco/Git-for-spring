...
public class SkinSangDto {
	private String sang_no, sang_Bname,sang_Pname, sang_price, sang_su, sang_detail, sang_image;

	public String getSang_no() {
		return sang_no;
	}

	public void setSang_no(String sang_no) {
		this.sang_no = sang_no;
	}
